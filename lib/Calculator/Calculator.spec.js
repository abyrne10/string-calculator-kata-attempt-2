...
describe('Calculator module', () => {
    describe('add', () => {
        ...
        it('should give the negative numbers found in the error message', () => {
            expect(() => { Calculator.add('1,-2,-3,-4,5'); }).to.throw(Error, 'Numbers passed to add must not be negative, -2,-3,-4 given');
        });
    });
});
